...
public class CalendarView extends FrameLayout {
    ...
    private void readAttributes(Context context, AttributeSet attrs) {
        ...
        // Saturday
        mAttributes.put(Attr.saturDayTextColor,
                a.getColor(R.styleable.CalendarView_satur_day_text_color, colorPrimary));
        mAttributes.put(Attr.saturDayBackgroundColor,
                a.getColor(R.styleable.CalendarView_satur_day_background_color,
        ...
        mAttributes.put(Attr.saturDay,
                a.getInt(R.styleable.CalendarView_offset_day, Calendar.SATURDAY));
    ...
    private void setMonthHeader(View view, Calendar month) {
        ...
        tvMonth.setText(DateFormat.format("yyyy / MM", month));
    ...
    private void setWeekHeader(View view, int weekHeaderVisible) {
        ...
        for (int i = 0 ; i < weekHeaderTexts.length ; i++) {
            ...
            weekHeaderTexts[i] = simpleText(new DateFormatSymbols(Locale.ENGLISH).getShortWeekdays()[dayIndex]);
        }
    ...
    private class CalendarPagerAdapter extends PagerAdapter {
        ...
        private void onBindView(int position,
            ...
            int saturDay = mAttributes.get(Attr.saturDay);
            int dayOffset = mAttributes.get(Attr.dayOffset);
            int startingWeekDay = mAttributes.get(Attr.startingWeekDay);
            boolean isSaturday = position % 7 == (7 + saturDay - startingWeekDay) % 7;
            ...
            if (isOffsetDay) {
                ...
                tvDay.setTextColor(mAttributes.get(Attr.saturDayTextColor));
                container.setBackgroundColor(mAttributes.get(Attr.saturDayBackgroundColor));
            }
            ...
            if (day.equals(mCurrentDate)) {
                if (isOffsetDay) {
                    ...
                    tvDay.setTextColor(mAttributes.get(Attr.saturDayTextColor));
                    tvDay.setSelectedColor(mAttributes.get(Attr.saturDayTextColor));
                } else {
    ...
    private static class Attr {
        ...
        static final int saturDay = 30;
        static final int saturDayTextColor = 31;
        static final int saturDayBackgroundColor = 32;
